...
- **❤️ Favorites Management**: Save movies to a persistent, personalized playlist stored directly in your browser's `localStorage` for offline persistence.
